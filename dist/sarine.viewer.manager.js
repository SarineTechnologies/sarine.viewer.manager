...
/*!
sarine.viewer.manager - v0.1.0 -  Tuesday, April 28th, 2015, 5:56:09 PM 
...
(function() {
  ...
  ViewerManger = (function() {
    ...
    function ViewerManger(option) {
      ...
      cacheVersion = configuration.cacheVersion || "v1";
      viewers = [];
    ...
    loadTemplate = function(selector) {
      ...
      deferArr = [];
      scripts = [];
      $("<div>").load(template + "?" + cacheVersion, function(a, b, c) {
    ...
    addViewer = function(type, toElement) {
      ...
      $.getJSON(jsons.replace("{version}", toElement.data("version") || "v1") + type + ".json?" + cacheVersion, (function(_this) {
        return function(d) {
          return data = d;
        };
      })(this));
      ...
      url = logicRoot.replace("{version}", toElement.data("version") || "v1") + data.name + (location.hash.indexOf("debug") === 1 ? ".bundle.js" : ".bundle.min.js") + "?" + cacheVersion;
      s = $("<script>", {
